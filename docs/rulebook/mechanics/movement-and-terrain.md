...
| **Attack (Deny)** | 1 | Commit an Attack token to a reaction slot to contest an enemy Attack that would remove an allied lane creep's last Hit. Requires a die roll. See Economy and Progression. |
