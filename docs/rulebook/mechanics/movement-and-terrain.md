...
| **Deny** | Reaction | Commit a 1 AP reaction during Planning Phase to contest an enemy Attack if that Attack would remove an allied lane creep's last remaining Hit. Requires a die roll. See Economy and Progression. |
